...
export const getServerSideProps = async context => {
	...
	if (query && query.key) {
		...
		// execute different custom computer builds based on the key value
		switch (key) {
			case 'low-gaming':
				defaultBuildSlug = "low-gaming-pc";
				break;
			case 'medium-gaming':
				defaultBuildSlug = "medium-gaming-pc";
				break;
			case 'high-gaming':
				defaultBuildSlug = "high-gaming-pc";
				break;
			case 'standard-streaming':
				defaultBuildSlug = "standard-streaming-pc";
				break;
			case 'high-streaming':
				defaultBuildSlug = "high-streaming-pc";
				break;
			case 'ultra-streaming':
				defaultBuildSlug = "ultra-streaming-pc";
				break;
			case 'workstation':
				defaultBuildSlug = "workstation-custom-pc";
				break;
			case 'high-standard-build':
				defaultBuildSlug = "high-standard-build";
				break;
			case 'high-high-build':
				defaultBuildSlug = "high-high-build";
				break;
			case 'high-ultra-build':
				defaultBuildSlug = "high-ultra-build";
				break;
			case 'med-standard-build':
				defaultBuildSlug = "med-standard-build";
				break;
			case 'med-high-build':
				defaultBuildSlug = "med-high-build";
				break;
			case 'med-ultra-build':
				defaultBuildSlug = "med-ultra-build";
				break;
			case 'low-standard-build':
				defaultBuildSlug = "low-standard-build";
				break;
			case 'low-high-build':
				defaultBuildSlug = "low-high-build";
				break;
			case 'low-ultra-build':
				defaultBuildSlug = "low-ultra-build";
				break;
			default:
