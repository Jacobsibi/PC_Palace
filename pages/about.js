...
const AboutPage = () => { return (
    ...
    <h4>Who are we?</h4>    
        ...
        In addition to building custom computers, we also offer a wide range of computer parts and accessories. Whether you're looking to upgrade your graphics card, add more RAM, or get a new case for your PC we've got you covered.
        <p>At PC Palace, we believe in providing our customers with the best possible PC shopping and building experience possible. That's why we offer free shipping on all orders, a 30-day money-back guarantee and dedicated customer support to help answer any questions you may have.
        Thanks for choosing PC Palace for all of your computer building needs. We look forward to helping you build the perfect computer!</p>
